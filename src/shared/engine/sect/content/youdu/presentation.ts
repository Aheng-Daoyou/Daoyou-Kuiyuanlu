...
export const YOUDU_SECT_PRESENTATION: SectPresentationTheme = {
  ...
  affairsRoom: {
    description: '招魂司内灯影不灭，巡灯、命簿与七灯问名各由一席经办。',
    taskNpcs: {
      daily: {
        ...
        name: '沈照灯',
        identity: '巡灯使',
        responsibility: '巡灯、阴脉与药器交付。',
        greeting: '今日还有几盏灯要照、几条归路要寻，你先挑一件。',
      },
      weekly: {
        id: 'youdu-bai-shoubu',
        sigil: '簿',
        name: '白守簿',
        identity: '命簿使',
        responsibility: '周录、照影与失名悬契。',
        greeting: '名字与归路都已写入本周命簿，你可逐项查验。',
      },
      promotion: {
        id: 'youdu-chu-yingui',
        sigil: '引',
        name: '楚引归',
        identity: '引魂师',
        responsibility: '七灯问名与晋升考校。',
        greeting: '七灯之下，守得住自己的名字，才有资格再往前走。',
      },
    },
  },
  terms: {
